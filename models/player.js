function createPlayers(){
  ...
  return class {
     ...
     makeCard(){
       ...
       return ` <div class="card col s12 m6 l4" style="margin-left: 10px;">
                  <div class="card-image waves-effect waves-block waves-light">
                    <img class="activator" src="${this.imageURL}">
                  </div>
                  <div class="card-content">
                    <span class="card-title activator grey-text text-darken-4">${this.name}<i class="material-icons right card-revealer" id="player-${this.id}">more_vert</i></span>
                    <p>${team.name}</p>
                  </div>
